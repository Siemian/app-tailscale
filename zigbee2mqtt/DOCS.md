...
This add-on is provided by a community fork that restores **32-bit (armv7)** support. The official [Zigbee2MQTT Home Assistant add-on](https://github.com/zigbee2mqtt/hassio-zigbee2mqtt) no longer supports 32-bit architectures. If you run Home Assistant on a 32-bit device (e.g. armv7), use this fork to install Zigbee2MQTT.
